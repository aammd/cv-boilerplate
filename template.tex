...
\noindent
$for(teaching)$
\note{$teaching.year$}\textbf{$teaching.title$}\\
\emph{$teaching.institute$}$if(teaching.city)$, $teaching.city$$endif$\\[.2cm]
$endfor$
$endif$
...
\emph{$publications.authors$}\\
$publications.journal$, $publications.volume$ ($publications.issue$): $publications.pages$\\[.2cm]
$endfor$
